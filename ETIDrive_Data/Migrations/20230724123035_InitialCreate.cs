        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Departments_Folders_FolderId",
                        column: x => x.FolderId,
                        principalTable: "Folders",
                        principalColumn: "FolderId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Datas_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Datas_AspNetUsers_ModifiedById",
                    ...
                    table.ForeignKey(
                        name: "FK_Datas_Folders_FolderId",
                        column: x => x.FolderId,
                        principalTable: "Folders",
                        principalColumn: "FolderId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFolders", x => new { x.Id, x.FolderId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DataPermissions", x => new { x.Id, x.DataId });
                    table.ForeignKey(
                        name: "FK_DataPermissions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DataPermissions_Datas_DataId",
                        column: x => x.DataId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DataTags", x => new { x.DataId, x.TagId });
                    table.ForeignKey(
                        name: "FK_DataTags_Datas_DataId",
                        column: x => x.DataId,
                        principalTable: "Datas",
                        principalColumn: "DataId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DataTags_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DataPermissions_DataId",
                table: "DataPermissions",
                column: "DataId");

            migrationBuilder.CreateIndex(
                name: "IX_DataPermissions_UserId",
                table: "DataPermissions",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Datas_CreatedById",
                table: "Datas",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_Datas_FolderId",
                table: "Datas",
                column: "FolderId");

            migrationBuilder.CreateIndex(
                name: "IX_Datas_ModifiedById",
                table: "Datas",
                column: "ModifiedById");

            migrationBuilder.CreateIndex(
                name: "IX_DataTags_TagId",
                table: "DataTags",
                column: "TagId");

            migrationBuilder.CreateIndex(
                name: "IX_Departments_FolderId",
                table: "Departments",
                column: "FolderId",
                unique: true,
